 ...
 * one: a default password is a publicly known key, so anything encrypted under
 * it is readable by anyone with a copy of this program.
 *
 * @author Othmane
 */
public class MainFrame extends javax.swing.JFrame implements PropertyChangeListener {
    ...
    /**
     * Loads {@link InputParameters}, builds the UI and centres it. If the
     * parameter file is missing, disables the window and shows the
     * corresponding error dialog.
     *
     * @throws InterruptedException if interrupted while loading parameters
     */
    ...
    private void initComponents() {
        ...
        DecryptingPanelLayout.setHorizontalGroup(
            ...
            .addGroup(DecryptingPanelLayout.createSequentialGroup()
                ...
                .addGroup(DecryptingPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(DecryptingPassword, javax.swing.GroupLayout.PREFERRED_SIZE, 115, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel2)
                    .addComponent(jCheckBox_OpenFile))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 145, Short.MAX_VALUE)
                // same gaps and alignment as the Encrypt tab, so the buttons don't shift when switching tabs
                .addGroup(DecryptingPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(DecryptingBrowserButton)
                    .addComponent(DecryptingButton, javax.swing.GroupLayout.PREFERRED_SIZE, 74, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(30, 30, 30))
        );
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                // 74 wide with a 41px right inset: same column as the tabs' Browse/Encrypt buttons
    ...
    private void EncryptingButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EncryptingButtonActionPerformed
        ...
        if (password1.length == 0) {
            this.ShowPasswordDialog("A password is required");
            return;
        }
     ...
     * the entered encrypting password can be unusable (empty, or mismatched).
     * Its OK/close handlers clear both fields and re-enable the window.
     *
    ...
    /**
     * @return {@code true} if the two entered passwords match exactly.
     */
